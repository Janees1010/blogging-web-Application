...
const Notifications = ()=>{
    ...
    const fetchNotifications = async ({page , deletedDocCount = 0})=>{
        ...
        await axios.post(import.meta.env.VITE_SERVER_DOMAIN + '/notifications',{page,filter, deletedDocCount},{
            headers:{
           ...
           // console.log(Array.isArray(notifications.results));
             ...
             <div className="my-8 flex gap-6">

                   {
                     filters.map((filterName , i)=>{
                       return <button className={"py-2 " + (filter == filterName ? "btn-dark" : "btn-light")} key={i} onClick={handleFilter}>{filterName}</button>
                     })
                   }
                  ...
                  <>
                        {
                         ...
                         <LoadMorebtn state={notifications} fetchData={fetchNotifications} additionalParam={{deletedDocCount : notifications.deletedDocCount}} />
