...
const BlogStats = ({stats})=>{
  return(
     <div className="flex gap-2 max-lg:mb-6 max-lg:pb-4 border-grey border-b">
         {

            Object.keys(stats).map((key,i)=>{
                return !key.includes('parent') ? <div key={i} className="flex flex-col items-center w-full h-full justify-center p-4 px-6 "> 
    ...
    return(
        ...
        <>
            ...
            <div className="flex gap-10 border-b mb-6 max-md:px-4 border-grey pb-6 items-center">
                    ...
                    <img src={banner} alt="" className="w-28 h-28 flex-none bg-grey object-cover max-md:hidden lg:hidden xl:block" />
 ...
 export const ManageDraftBlogCard =({blog})=>{
    ...
    return(
        <div className="flex gap-5 lg:10 pb-6 border-b mb-6 border-grey ">

            <h1 className="text-center blog-index pl-4 md:pl-6 flex-none">{index < 10 ? "0" + index : index }</h1>
