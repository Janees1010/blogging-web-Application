...
const BlogPostCard = ({content,author}) =>{
    ...
    let {title , publishedAt , des , banner , tags ,activity: {total_likes} , blog_id : id } = content
    let {fullname , username ,profile_img} = author

    return(
      <Link to={`/blog/${id}`} className="flex gap-8 items-center border-b border-grey pb-5 mb-5">
         ...
         <div className="w-full">
          ...
          <div className="flex gap-4 mt-7">
             ...
             <span className="mle-3 flex items-center gap-2 text-dark-grey">
